                        ...
                        <div class="h-100">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                   ...
                                   <span><a class="btn btn-primary py-3 px-5" href="viewpackage.php?selpackageid=<?php echo $display["packageid"]; ?>">View More package</a></span>
                                </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <a class="btn btn-primary py-3 px-5" href="">Check Packages</a>
                </div>
                <div class="col-lg-6">
